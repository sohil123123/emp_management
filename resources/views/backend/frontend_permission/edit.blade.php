                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="d-inline-block dropdown float-right">
                                            <form action="{{ route('admin.frontend-permissions.destroy', [$permission->id]) }}" method="post">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('admin.frontend-permissions.update', [$permission->id]) }}" method="post" enctype="multipart/form-data" class="frontend_permission_form">
                                        @csrf
                                        @method('put')
                                        <div class="row">
                                            <div class="col-md-4">
