                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="d-inline-block dropdown float-right">
                                            <a href="{{ route('admin.backend-roles.index') }}" class="btn btn-outline-primary btn-sm"><i class="feather icon-chevrons-left"></i>Return</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('admin.backend-roles.store') }}" method="post" enctype="multipart/form-data" class="backend_role_form">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <a href="{{ route('admin.backend-roles.index') }}" class="btn btn-glow-dark btn-dark btn-sm"><i class="feather icon-x-circle"></i>Cancel</a>
                                    </div>
                                </div>
                            </div>
                            <!-- [ Hover-table ] end -->
