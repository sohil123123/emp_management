                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('departments.update',[$department->id]) }}" method="post" enctype="multipart/form-data" class="department_form">
                                        @csrf
                                        @method('put')
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" placeholder="Enter Department name" class="form-control" value="{{ $department->name }}" required>
                                                        @if ($errors->has('name'))
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" class="form-control uppercase" required>
                                                            ...
                                                            <option value="0" {{ $department->status == '0' ? "selected" : '' }}>Deactive</option>
                                                        </select>
