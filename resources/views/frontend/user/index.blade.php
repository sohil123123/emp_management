                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="d-inline-block dropdown float-right">
                                            @can('add_users')
                                                <a href="{{ route('users.create') }}" class="btn btn-glow-primary btn-primary btn-sm"><i class="feather icon-plus-circle"></i>Add New Employee</a>
                                            @endcan

                                            @can('delete_users')
                                                <button class="btn btn-glow-danger btn-danger btn-sm user_bulk_delete" data-url="{{ route('users.bulkremove') }}"><i class="feather icon-trash-2"></i>Bulk Delete</button>
                                            @endcan
