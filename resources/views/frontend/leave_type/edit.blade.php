                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('leave-types.update', [$leave_type->id]) }}" method="post" enctype="multipart/form-data" class="leave_type_form">
                                        @csrf
                                        @method('put')
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" placeholder="Enter Leave Type Name" class="form-control" value="{{ $leave_type->name }}" required>
                                                        @if ($errors->has('name'))
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" class="form-control uppercase" required>
                                                            ...
                                                            <option value="1" {{ $leave_type->status == '1' ? "selected" : '' }}>Active</option>
                                                            <option value="0" {{ $leave_type->status == '0' ? "selected" : '' }}>Deactive</option>
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" class="form-control" placeholder="Description" required>{!! $leave_type->description !!}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::select('leave_group_ids[]', $leave_groups, isset($leave_type) ? $leave_type->leave_groups->pluck('id')->toArray() : null,  ['class' => 'form-control select2', 'multiple']) !!}
