                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('leave-groups.store') }}" method="post" enctype="multipart/form-data" class="leave_group_form">
                                        @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Leave Group Name</label>
                                                        <input type="text" name="name" placeholder="Enter Leave Group Name" class="form-control" value="{{old('name')}}" required>
                                                        @if ($errors->has('name'))
