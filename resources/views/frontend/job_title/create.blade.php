                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('job-titles.store') }}" method="post" enctype="multipart/form-data" class="job_title_form">
                                        @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Job Title</label>
                                                        <input type="text" name="name" placeholder="Enter Job Title" class="form-control" value="{{old('name')}}" required>
                                                        @if ($errors->has('name'))
